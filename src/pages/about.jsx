        ...
        <div className="row">
                ...
                <div className="col-md-6">
                    <div className="">
                          ...
                          <p className='pt-2 fs-normal text-black fs- '>Steelgrey Cleaning Specialists provides a full range of residential and commercial cleaning services in Lagos & Abuja. Whether you need a daily cleaning package, a deep clean or other cleaning services, our reliable and flexible team can cater to your needs with bespoke packages.</p>
