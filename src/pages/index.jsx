          ...
          <nav class="navbar navbar-expand-lg pt-2">
            <div class="container-fluid">
              ...
              >
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 fs-6 fw-medium ">
                  <li class="nav-item me-4 ">
                    <Link href="/services" class="nav-link text-white active">
                      {" "}
                      Services
                    </Link>
                  </li>
                  <li class="nav-item me-4 ">
                    <Link href="/about" class="nav-link text-white active">
                      {" "}
                      About
                    </Link>
                  </li>
                  <li class="nav-item me-4 ">
                    <Link href="/join" class="nav-link text-white active">
                      Join Our Team
                    </Link>
                  </li>
                  {/* <li class="nav-item me-4 ">
              <a class="nav-link text-white " href="/review">Review</a>
                ...
                <button
                  class="btn text-color bg-white fw-medium py-2 px-4 shadow-lg m-0"
                  type="submit"
                >
          ...
          <div className="row ps-0">
            ...
            <div className="col-md-6 ui-hide-only">
              <div className="pt-5 mt-4">
                <h1 className="fs-xxxlarge lh-1 text-color mb-4">
                  Professional <br /> cleaning <br /> service
                </h1>
                <p className="pt-3 fs-normal p-md-4 ps-md-0 pb-md-0">
                  Steelgrey Cleaning Specialists are on a mission to achieve
                  excellent and customer-centered cleaning services that
                  delicately cater to the satisfaction of every client.
                </p>
                <p className="fs-normal ">
                  With Steelgrey, you can experience an all-time best cleaning
                  service.
                </p>
              </div>
            </div>
            ...
            <div className="col-md-6 ui-show-only ui-hide-big">
              <div className="pt-2 mt-2">
                <h1
                  className="fs-xxlarge line-height text-color
                        mb-4"
                >
