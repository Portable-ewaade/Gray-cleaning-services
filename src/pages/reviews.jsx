            ...
            <div className="row">
              <div className="col-md-6">
                <div className="pt-5 mt-4">
                  <h1 className="fs-xxxlarge line-height text-color mb-4 mt-md-5 pt-md-5">
                    Our Reviews
                  </h1>
                  <p className="pt-3 fs-normal">
                    We’re proud of the high standards we achieve, but don’t just
                    take our word for it. Read our recent reviews to help you
                    make the right decision when choosing your next cleaning
                    company.
                  </p>
                </div>
              </div>
                  ...
                  <div>
                    <p className="fs-normal text-center ">
                      <q className="">
                        ...
                        clients have been delighted with their work be it end of
                        tenancy cleans, full sterilised cleans or usual home
                        cleans. We will certainly continue to use Doris in the
                        future as it is so important to have reliable
