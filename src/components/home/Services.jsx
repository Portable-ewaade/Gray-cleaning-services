  ...
  return (
    <div className='container mt-5 p-4 p-md-5'>
        <div className="row">
            ...
            <div className="col-md-6 mb-5 mt-5">
                <div
                    class="card border-0 mt-5 mt-md-0"  style={{height: "25rem"}} 
                     >
                <div class="card-body text-center shadow-lg">
                     <div className="position-absolute text-center start-0 end-0">
            ...
            <div className="col-md-6 mb-5 mt-5">
                <div
                    class="card border-0 position relative mt-5 mt-md-0" style={{height: "25rem"}}
                     >
                <div class="card-body text-center shadow-lg ">
                    <div className="position-absolute text-center start-0 end-0">
            ...
            <div className="col-md-6 mb-5 mt-5">
                <div
                    class="card border-0 mt-4 mt-md-0" style={{height: "25rem"}} 
                     >
                <div class="card-body text-center shadow-lg">
                <div className="position-absolute text-center start-0 end-0">
