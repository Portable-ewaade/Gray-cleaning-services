  ...
  return (
    <div>
        ...
        <div className="row">
                <div className="col-md-6">
                    <div className="card border-0">
                            <img src="../../../../assets/cleaning2.jpeg" alt="..." className='mb-4'/>
                        </div>
                    </div>
        ...
        <div className="container p-5 mt-1">
            <div className="row">
                <div className="col-md-6">
                    <div className=" mt-3 ">
                          <h1 className='fs-xxlarge line-height text-color mb-4'>Safe Contractor Accredited</h1>
                ...
                <div className="col-md-6">
                <div className="card border-0">
                         <img src="../../../../assets/cleaning4.jpg" alt="..." className=''/>
                    </div>
                </div>
            </div>
        </div>
