  ...
  return (
    <div>
        <div className="container ">
            <hr />
           <div className="">
                <h1 className='text-color my-5 fw-light fs-xxxlarge'>3 Ways To Get The Best Cleaning Service</h1>
           </div>
           <div className="row ">
                ...
                <div className="text-color d-flex justify-content-end my-4">
                    <h4 className='fw-normal'>Schedule A Free Consultation.
                      <a href="/getStarted">
    ...
    <section className='happy-customer-section'>
      <div className='container text-black'>
        <div className='row'>
          ...
          <h1 className='mt-5 pt-4 mb-4 text-center fs-xxxlarge text-color'>Happy Customers Make Our Services Worthwhile!</h1>
            <div className="row">
