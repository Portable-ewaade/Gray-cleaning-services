            ...
            <form className="text-black" ref={form} onSubmit={sendEmail}>
              ...
              <div className="row">
                <div className="col-lg-6 col-6 mt-3">
                  <label htmlFor="InputTelephone" class="form-label">
                    Telephone:
                  </label>
                  <input
                    type="Telephone"
              ...
              <div className="col-lg-12 col-12 mt-3">
                <label htmlFor="InputText" class="form-label">
                  Please specify if its a Regular/One off/Monthly/Commercial
                  Cleaning
                </label>
                <input
                  type="text"
              ...
              <div className="row">
                <div className="col-md-12 mb-3">
                  <label htmlFor="floatingTextarea2 mb-4 mt-4">
                    Further information:
                  </label>
