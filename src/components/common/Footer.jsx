      ...
      <div className="container text-black">
        <div className="row mt-3 ">
          <div className="col-md-3">
            <h6>
              <a href="tel: +2349035169253">Doris: +2349035169253 (Lagos) </a>
            </h6>
            <h6>
              {" "}
              <a href="tel: +2348097659230">Fechi: +2348097659230 (Abuja) </a>
            </h6>
          ...
          <div className="col-md-3">
            <a href="#">
              <ul className="px-1">Domestic Cleaning</ul>
            </a>
            <a href="#">
            ...
            <a href="#">
              <ul className="px-1">Serviced Accommodating cleaning</ul>
            </a>
            <a href="#">
              <ul className="px-1">Office Cleaning</ul>
            </a>
          </div>
          ...
          <div className="col-md-3">
            ...
            <a href="#">
              <ul className="px-1">Commercial cleaning</ul>
            </a>
            <a href="#">
              <ul className="px-1">Carpet and Upholstery Cleaning</ul>
            </a>
          </div>
          <hr className="d-md-none mt-4" />
          <div className="col-md-3">
        ...
        <div className="container">
          <div className="row mt-5 pt-md-4 pt-3 ">
            <div className="col-md-6">
              <p>Copyright &copy; Steelgrey Cleaning 2023 </p>
            </div>
            <div className="col-md-6">
              <a href="#">
                <ul className="px-1">Privacy Policy Terms & Conditions</ul>
              </a>
            </div>
          </div>
        </div>
